...
__decorate([
    (0, graphql_1.Query)(() => category_entity_1.Category, { name: "findCategoryBySlug" }),
    __param(0, (0, graphql_1.Args)("slug", { type: () => String })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], CategoriesResolver.prototype, "filter", null);
__decorate([
    (0, graphql_1.ResolveField)((returns) => [product_entity_1.Product], { name: "products" }),
    __param(0, (0, graphql_1.Parent)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [category_entity_1.Category]),
    __metadata("design:returntype", Promise)
], CategoriesResolver.prototype, "getProducts", null);
